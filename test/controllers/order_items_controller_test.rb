...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference("OrderItem.count") do
      post order_items_url, params: { order_item: { order_id: @order_item.order_id, plant_id: @order_item.plant_id, quantitiy: @order_item.quantitiy } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { order_id: @order_item.order_id, plant_id: @order_item.plant_id, quantitiy: @order_item.quantitiy } }
